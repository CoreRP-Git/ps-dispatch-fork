<script>
  ...
  function getDispatchData(dispatch) {
    return [
      { icon: 'fas fa-clock', label: 'Klokkeslett', value: timeAgo(dispatch.time) },
      { icon: 'fas fa-user', label: 'Personalia', value: dispatch.name },
      { icon: 'fas fa-phone', label: 'Mobiltelefon', value: dispatch.number },
      { icon: 'fas fa-comment', label: 'Info', value: dispatch.information },
      { icon: 'fas fa-map-location-dot', label: 'Posisjon', value: dispatch.street },
      { icon: 'fas fa-user', label: 'Kjønn', value: dispatch.gender },
      { icon: 'fas fa-gun', label: 'Automatisk skuddveksling', value: dispatch.automaticGunFire },
      { icon: 'fas fa-gun', label: 'Våpentype', value: dispatch.weapon },
      { icon: 'fas fa-car', label: 'Kjøretøymodell', value: dispatch.vehicle },
      { icon: 'fas fa-rectangle-list', label: 'Skiltplate', value: dispatch.plate },
      { icon: 'fas fa-droplet', label: 'Farge', value: dispatch.color },
      { icon: 'fas fa-car', label: 'Klasse', value: dispatch.class },
      { icon: 'fas fa-door-open', label: 'Dører', value: dispatch.doors },
      { icon: 'fas fa-compass', label: 'Retning', value: dispatch.heading },
